...
auto NeuralNet::train(const TrainingData& trainingData, unsigned int iterations) -> void
{
...
auto NeuralNet::feedForward(const std::vector<double>& inputVals) -> void
{
...
auto NeuralNet::backProp(const std::vector<double>& targetVals) -> void
{
...
auto NeuralNet::getResults(std::vector<double>& resultVals) const -> void
{
	resultVals.clear();
